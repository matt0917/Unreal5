...
class CustomToolMenu:
    ...
    def add_menu_item(cls):
        ...
        python_menu = main_menu.add_sub_menu(
            "Python", section_name="CustomScripts", name="MPTools_TMenu", label="MP PyTools")
        if not python_menu:
        ...
        unfold_selected_actors_menu_entry = cls.unfold_selected_actors_entry()
        ...
        python_menu.add_menu_entry("CustomScripts", unfold_selected_actors_menu_entry)
    ...
    @classmethod
    def unfold_selected_actors_entry(cls):
        # Define the menu entry
        menu_entry = unreal.ToolMenuEntry(
            name="UnforldSelectedActor_func",
            owner=unreal.ToolMenuOwner("Python"),
            insert_position=unreal.ToolMenuInsert(
                position=unreal.ToolMenuInsertType.FIRST),
            type=unreal.MultiBlockType.MENU_ENTRY
        )
        menu_entry.set_label("Unfold selected Actors in the Outliner")
        menu_entry.set_tool_tip("Unfold selected actors in the outliner.")
        # Set the command to execute the Python function
        menu_entry.set_string_command(
            type=unreal.ToolMenuStringCommandType.PYTHON,
            custom_type="",
            string="asset_utils.unfold_selected_actors_in_outliner()"
        )
        return menu_entry
    ...
    def unfold_all_actors_entry(cls):
        ...
        menu_entry.set_string_command(
            type=unreal.ToolMenuStringCommandType.PYTHON,
            custom_type="",
            string="asset_utils.unfold_all_actors_in_outliner()"
        )
        return menu_entry
